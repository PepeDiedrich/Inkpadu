...
class AzureAssistantApiService {
  ...
  /// Löscht das gecachte Access-Token.
  ///
  /// Sollte beim Logout aufgerufen werden, um sicherzustellen, dass keine
  /// veralteten oder ungültigen Tokens im Speicher verbleiben.
