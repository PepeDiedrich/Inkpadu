...
class _DrawingCanvasState extends State<DrawingCanvas> {
  ...
  double _requiredCanvasHeightForStrokes(List<Stroke> strokes) {
    ...
    for (final stroke in strokes) {
      ...
      // Optimization: Use cached bounding box (O(1) access) instead of iterating all points (O(P)).
      // This reduces complexity of height calculation from O(TotalPoints) to O(Strokes).
