...
class InkNotePageDto {
	...
	const InkNotePageDto({required this.index, required this.strokes});
	...
	NotePage toDomain() => NotePage(strokes: List<Stroke>.unmodifiable(strokes));
	...
	factory InkNotePageDto.fromJson(Map<String, dynamic> json) {
		...
		return InkNotePageDto(index: effectiveIndex, strokes: decodedStrokes);
	}
}
