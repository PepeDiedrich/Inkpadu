...
class InkNoteDto {
  ...
  factory InkNoteDto.fromDomain(InkNote note, {required String userId}) => InkNoteDto(
        id: note.id,
        userId: userId,
        title: note.title,
        paperStyle: note.paperStyle.name,
        pageData: jsonEncode(note.page.toJson()),
  ...
  InkNote toDomain() {
    ...
    return InkNote(
      ...
      page: NotePage.fromJson(jsonDecode(pageData) as Map<String, dynamic>),
